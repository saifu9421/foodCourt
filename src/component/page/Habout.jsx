...
const Habout = () => {
    return (
        <div>
           ...
           <div className="   grid lg:flex md:flex  gap-9 items-start lg:mt-20 md:mt-5 mt-5 mb-4 lg:mb-20 md:mb-7  md:mx-auto mx-auto w-11/12 lg:mx-auto">
              <div>
          ...
          <div className="grid grid-cols-3 lg:grid-cols-3 md:grid-cols-3  lg:gap-4 md:gap-6 gap-5   lg:ml-0 md:ml-0 mt-5 lg:mt-5 md:mb-5">

 

<img className="w-44 rounded-lg gap-96" src="https://i.ibb.co/XJQbvGC/whole-chicken-grill-served-with-rice-garnish-white-plate.jpg" alt="" />
